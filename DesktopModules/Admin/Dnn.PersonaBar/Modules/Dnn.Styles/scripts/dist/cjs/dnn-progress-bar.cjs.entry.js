...
const DnnProgressBar = class {
    ...
    render() {
        return (index.h(index.Host, { key: '04cd93887008110d0280770c25a16518026c3c7e' }, index.h("progress", { key: '66894a7d6b4e858faac3f1b9767c84316d989451', class: this.getProgressClass(), max: this.max, value: this.value })));
    }
};
DnnProgressBar.style = dnnProgressBarCss;

exports.dnn_progress_bar = DnnProgressBar;
//# sourceMappingURL=dnn-progress-bar.entry.cjs.js.map
