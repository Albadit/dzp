...
const DnnVerticalSplitview = class {
    ...
    render() {
        return (index.h(index.Host, { key: '973c2ce7e73ad5a85289742fbc763fd0d85ae778' }, index.h("div", { key: '05364ed25d82a0f9f24c5f6eb353779143c44a3d', class: "left pane", style: {
                width: `${this.leftWidth}px`,
            } }, index.h("slot", { key: 'd323a96a7a346a2ce460d9f059ad5903b10bac4a', name: "left" })), index.h("button", { key: '396549b3475dde05f990ee044937c19c831102d8', onMouseDown: e => this.handleMouseDown(e), onTouchStart: e => this.handleMouseDown(e), onKeyDown: e => this.handleKeyDown(e), ref: el => this.splitter = el, style: {
                minWidth: `${this.splitterWidth.toString()}px`,
                left: `${this.leftWidth - 2}px`,
            } }, index.h("slot", { key: '6b8c2671b8f2ccd559f3218631c3af252d1c41a1' })), index.h("div", { key: 'fbc6413754c4a90b562e7f329848a9d3650e41d4', class: "right pane", style: {
                width: `${this.rightWidth}px`,
            } }, index.h("slot", { key: 'ed0fea3f906ba6cf1b007c35788c0c3b362d2d0a', name: "right" }))));
    }
...
//# sourceMappingURL=dnn-vertical-splitview.entry.cjs.js.map
