...
const DnnAutocomplete = class {
    constructor(hostRef) {
        ...
        this.needMoreItems = index.createEvent(this, "needMoreItems", 7);
        this.searchQueryChanged = index.createEvent(this, "searchQueryChanged", 7);
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '1e292d089aaa274d1aa4b9898bd0d9d15b7d6d70', tabIndex: this.focused ? -1 : 0, onFocus: () => this.inputField.focus(), onBlur: () => this.inputField.blur() }, index.h("dnn-fieldset", { key: 'd70181acb451533a2ecb842b16bb9a1f4786d5e5', ref: el => this.fieldset = el, invalid: !this.valid, focused: this.focused, label: `${(_a = this.label) !== null && _a !== void 0 ? _a : ""}${this.required ? " *" : ""}`, helpText: this.helpText, id: this.labelId, disabled: this.disabled, floatLabel: this.shouldLabelFloat() }, index.h("div", { key: 'b91badc6ea15ecaeeb7b8f24383b8dbc7eeb1ceb', class: "inner-container" }, index.h("input", { key: 'e2dd5f4e2179dc5d61e6e5faf5f62bfac8e96ae1', ref: (el) => this.inputField = el, name: this.name, type: "search", role: "combobox", "aria-haspopup": "listbox", "aria-expanded": this.focused.toString(), "aria-activedescendant": this.selectedIndex !== undefined ? `option-${this.selectedIndex}` : undefined, disabled: this.disabled, required: this.required, autoComplete: this.autocomplete, value: this.displayValue, onFocus: () => {
            ...
            index.h("svg", { key: 'c5678ec6aebde3e12654d23996f5e7800a44011d', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", class: "error" }, index.h("path", { key: 'e3d61322deab9289f34f64f03dbda93721334f3b', d: "M479.982-280q14.018 0 23.518-9.482 9.5-9.483 9.5-23.5 0-14.018-9.482-23.518-9.483-9.5-23.5-9.5-14.018 0-23.518 9.482-9.5 9.483-9.5 23.5 0 14.018 9.482 23.518 9.483 9.5 23.5 9.5ZM453-433h60v-253h-60v253Zm27.266 353q-82.734 0-155.5-31.5t-127.266-86q-54.5-54.5-86-127.341Q80-397.681 80-480.5q0-82.819 31.5-155.659Q143-709 197.5-763t127.341-85.5Q397.681-880 480.5-880q82.819 0 155.659 31.5Q709-817 763-763t85.5 127Q880-563 880-480.266q0 82.734-31.5 155.5T763-197.684q-54 54.316-127 86Q563-80 480.266-80Zm.234-60Q622-140 721-239.5t99-241Q820-622 721.188-721 622.375-820 480-820q-141 0-240.5 98.812Q140-622.375 140-480q0 141 99.5 240.5t241 99.5Zm-.5-340Z" })), index.h("ul", { key: '46bf9ea05343a94b1bef9fabbed0e4f31536952d', class: this.focused && this.suggestions.length > 0 ? "show" : "", role: "listbox", ref: el => this.suggestionsContainer = el, onScroll: () => this.handleSuggestionsScroll() }, this.suggestions.map((suggestion, index$1) => (index.h("li", { id: `option-${index$1}`, role: "option", "aria-selected": this.selectedIndex == index$1, class: this.selectedIndex == index$1 ? "selected" : "", onClick: e => this.selectItem(e, index$1) }, this.renderSuggestion != undefined ? this.renderSuggestion(suggestion) : suggestion.label))), this.totalSuggestions != undefined && this.totalSuggestions > this.suggestions.length &&
            index.h("div", { key: '6a0e9fc2f6dbbb0e7333631d60e131aa3e24ed05', class: "loading" }), this.totalSuggestions != undefined && this.totalSuggestions > this.suggestions.length && this.positionInitialized &&
            index.h("div", { key: '5b5195357e3f0f257837485dd08e487f3302830e', style: { height: `${this.getVirtualScrollHeight()}px` } })), index.h("svg", { key: '6add57764f3df4fde8d95fc049e1e1f9a03afb96', onClick: () => this.handleDropdownClick(), class: "chevron-down", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960" }, index.h("path", { key: '2f25891e79ba26598884234386e6b57612741c48', d: "M480-345 240-585l56-56 184 184 184-184 56 56-240 240Z" }))))));
    }
...
exports.dnn_autocomplete = DnnAutocomplete;
//# sourceMappingURL=dnn-autocomplete.entry.cjs.js.map
