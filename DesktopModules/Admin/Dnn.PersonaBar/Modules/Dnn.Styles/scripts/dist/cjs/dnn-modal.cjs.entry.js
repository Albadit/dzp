...
const DnnModal = class {
    ...
    */
    ...
    render() {
        return (index.h(index.Host, { key: 'ddeada006779331fcb74c7f2281bbda06a49e5d3' }, index.h("div", { key: '7c7d637a303053b61c476e4f6bbb532c36854f7b', id: "backdrop", class: this.visible ? 'overlay visible' : 'overlay', onClick: e => this.handleBackdropClick(e) }, index.h("div", { key: 'bc52fa86e8044021c807b3598d7227d785aea0e2', class: "modal", ref: el => this.modal = el }, !this.hideCloseButton &&
            index.h("button", { key: '9cf2795520c1b72bfea7af95e87b02633ee1ccb4', class: "close", "aria-label": this.closeText, onClick: () => this.handleDismiss() }, index.h("svg", { key: '79ac8158160b83d05c40629a2a9a2bdab257996a', xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "#000000" }, index.h("path", { key: '2357184605325b21c6beadfb307b03144b5107bf', d: "M0 0h24v24H0z", fill: "none" }), index.h("path", { key: '0276464aa40478c06e2725f3019593969aec7623', d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z" }))), index.h("div", { key: '1e1c69007aaa127e06b3a0806571f8b6af7528f7', class: "content" }, index.h("slot", { key: '97760d2eeee42b0ac407457a33b3b8a1c459d86e' })), this.resizable && index.h("div", { key: 'ae36ffb6d05bdbc573577123c1b8318819b659ad', class: 'se', ref: el => this.seDrag = el })))));
    }
...
//# sourceMappingURL=dnn-modal.entry.cjs.js.map
