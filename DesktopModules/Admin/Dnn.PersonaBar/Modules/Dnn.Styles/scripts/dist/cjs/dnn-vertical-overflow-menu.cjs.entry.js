...
const DnnVerticalOverflowMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2364aa395039a41afab0bfee412f3d6233b19cdb' }, index.h("div", { key: '75668da9020f756b9744e71eb5c231d954e78331', class: "menu-container" }, index.h("div", { key: '36115df47584d24df883c8cc4db3016565c288bd', class: "menu", ref: el => this.menu = el }, index.h("slot", { key: '9b77dcb5d7f3cbb7ad0e523cfcc8e08298bdf1aa' })), this.showDropdownButton &&
            index.h("div", { key: '44d66e5f7678a0822e4a28a3174b824a4c035f10', class: "overflow" }, index.h("button", { key: '40247829bafed117a5ff180f87ec0a1b25477775', ref: el => this.button = el, class: "icon", onClick: () => this.toggleOverflowMenu() }, index.h("svg", { key: 'd0f7567401ac63e3f69d236fad1cfbc5c4ceaae0', xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "#000000" }, index.h("path", { key: '146a8994c8febbdd67ba5e1063af0045e8e3f523', d: "M0 0h24v24H0z", fill: "none" }), index.h("path", { key: '5b0e043b91068ca0a0be62571ef3249762a13bd8', d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" }))), index.h("div", { key: '69318fbe2921e8f9c6f3e292e734e8f6a06a456b', class: "dropdown", ref: el => this.dropdown = el }, index.h("slot", { key: '5e9ce3e4d3ad7765f70423764d1cccf4f83ab034', name: "dropdown" }))))));
    }
...
//# sourceMappingURL=dnn-vertical-overflow-menu.entry.cjs.js.map
