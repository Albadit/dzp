...
import { d as defineCustomElement$a } from './dnn-button2.js';
import { d as defineCustomElement$9 } from './dnn-color-input2.js';
import { d as defineCustomElement$8 } from './dnn-color-picker2.js';
import { d as defineCustomElement$7 } from './dnn-fieldset2.js';
import { d as defineCustomElement$6 } from './dnn-input2.js';
import { d as defineCustomElement$5 } from './dnn-modal2.js';
import { d as defineCustomElement$4 } from './dnn-tab2.js';
import { d as defineCustomElement$3 } from './dnn-tabs2.js';
import { d as defineCustomElement$2 } from './dnn-toggle2.js';
...
const DnnStylesModule$1 = /*@__PURE__*/ proxyCustomElement(class DnnStylesModule extends HTMLElement {
    ...
    get el() { return this; }
    static get style() { return dnnStylesModuleScss; }
}, [257, "dnn-styles-module", {
        "resx": [32],
        "originalStyles": [32],
        "styles": [32],
        "isHost": [32]
...
function defineCustomElement$1() {
    ...
    const components = ["dnn-styles-module", "dnn-button", "dnn-color-input", "dnn-color-picker", "dnn-fieldset", "dnn-input", "dnn-modal", "dnn-tab", "dnn-tabs", "dnn-toggle"];
    components.forEach(tagName => { switch (tagName) {
        case "dnn-styles-module":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DnnStylesModule$1);
            }
            break;
        case "dnn-button":
            if (!customElements.get(tagName)) {
...
const DnnStylesModule = DnnStylesModule$1;
const defineCustomElement = defineCustomElement$1;

export { DnnStylesModule, defineCustomElement };
