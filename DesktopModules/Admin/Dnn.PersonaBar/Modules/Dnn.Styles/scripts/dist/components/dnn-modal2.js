...
const DnnModal = /*@__PURE__*/ proxyCustomElement(class DnnModal extends HTMLElement {
    ...
    */
    ...
    get el() { return this; }
    static get style() { return dnnModalCss; }
}, [257, "dnn-modal", {
        "backdropDismiss": [4, "backdrop-dismiss"],
        "preventBackdropDismiss": [1540, "prevent-backdrop-dismiss"],
        "closeText": [1, "close-text"],
        "resizable": [4],
        "showCloseButton": [4, "show-close-button"],
        "hideCloseButton": [1540, "hide-close-button"],
        "visible": [1540],
        "show": [64],
        "hide": [64]
    }]);
function defineCustomElement() {
    ...
    const components = ["dnn-modal"];
    components.forEach(tagName => { switch (tagName) {
        case "dnn-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DnnModal);
            }
            break;
    } });
}

export { DnnModal as D, defineCustomElement as d };
//# sourceMappingURL=dnn-modal2.js.map
