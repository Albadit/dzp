...
import { d as defineCustomElement$3 } from './dnn-dropzone2.js';
import { d as defineCustomElement$2 } from './dnn-modal2.js';
...
const DnnImageCropper$1 = /*@__PURE__*/ proxyCustomElement(class DnnImageCropper extends HTMLElement {
    ...
    static get style() { return dnnImageCropperCss; }
}, [321, "dnn-image-cropper", {
        "width": [2],
        "height": [2],
        "resx": [16],
        "quality": [2],
        "preventUndersized": [4, "prevent-undersized"],
        "name": [1],
        "view": [32],
        "localResx": [32],
        "fileName": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["dnn-image-cropper", "dnn-dropzone", "dnn-modal"];
    components.forEach(tagName => { switch (tagName) {
        case "dnn-image-cropper":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DnnImageCropper$1);
            }
            break;
        case "dnn-dropzone":
            if (!customElements.get(tagName)) {
...
const DnnImageCropper = DnnImageCropper$1;
const defineCustomElement = defineCustomElement$1;

export { DnnImageCropper, defineCustomElement };
