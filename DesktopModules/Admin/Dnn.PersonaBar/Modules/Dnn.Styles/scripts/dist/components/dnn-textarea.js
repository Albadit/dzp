...
const DnnTextarea$1 = /*@__PURE__*/ proxyCustomElement(class DnnTextarea extends HTMLElement {
    ...
    static get style() { return dnnTextareaCss; }
}, [321, "dnn-textarea", {
        "resizable": [1],
        "value": [1025],
        "label": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["dnn-textarea", "dnn-fieldset"];
    components.forEach(tagName => { switch (tagName) {
        case "dnn-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DnnTextarea$1);
            }
            break;
        case "dnn-fieldset":
            if (!customElements.get(tagName)) {
...
const DnnTextarea = DnnTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { DnnTextarea, defineCustomElement };
//# sourceMappingURL=dnn-textarea.js.map
