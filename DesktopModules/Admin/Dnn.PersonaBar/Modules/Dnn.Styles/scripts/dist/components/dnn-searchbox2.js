...
const DnnSearchbox = /*@__PURE__*/ proxyCustomElement(class DnnSearchbox extends HTMLElement {
    ...
    static get style() { return dnnSearchboxCss; }
}, [257, "dnn-searchbox", {
        "placeholder": [1],
...
function defineCustomElement() {
    ...
    const components = ["dnn-searchbox"];
    components.forEach(tagName => { switch (tagName) {
        case "dnn-searchbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DnnSearchbox);
            }
            break;
    } });
}

export { DnnSearchbox as D, defineCustomElement as d };
//# sourceMappingURL=dnn-searchbox2.js.map
