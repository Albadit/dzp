...
const DnnAutocomplete$1 = /*@__PURE__*/ proxyCustomElement(class DnnAutocomplete extends HTMLElement {
    ...
    static get style() { return dnnAutocompleteCss; }
}, [321, "dnn-autocomplete", {
        "label": [1],
        "name": [1],
        ...
        "suggestions": [16],
        "renderSuggestion": [16],
        "totalSuggestions": [2, "total-suggestions"],
        "preloadThresholdPixels": [2, "preload-threshold-pixels"],
        "autocomplete": [1],
        "focused": [32],
        "valid": [32],
        "customValidityMessage": [32],
        "selectedIndex": [32],
        "positionInitialized": [32],
        "lastScrollTop": [32],
        "displayValue": [32],
        "checkValidity": [64],
...
__decorate([
    Debounce(300)
], DnnAutocomplete$1.prototype, "handleSearchQueryChanged", null);
__decorate([
    Debounce(100)
], DnnAutocomplete$1.prototype, "handleSuggestionsScroll", null);
__decorate([
    Debounce()
], DnnAutocomplete$1.prototype, "checkIfMoreItemsNeeded", null);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dnn-autocomplete", "dnn-fieldset"];
    components.forEach(tagName => { switch (tagName) {
        case "dnn-autocomplete":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DnnAutocomplete$1);
            }
            break;
        case "dnn-fieldset":
            if (!customElements.get(tagName)) {
...
const DnnAutocomplete = DnnAutocomplete$1;
const defineCustomElement = defineCustomElement$1;

export { DnnAutocomplete, defineCustomElement };
