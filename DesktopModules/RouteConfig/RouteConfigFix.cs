...
namespace DnnDev.Routing
{
    ...
    /// (rewritten to /[community]/home by RouteConfig), DNN strips the
    /// brackets → canonical = /community/home → mismatch → 301.
    ///
    /// Fix: if RouteConfig already resolved a slug route (ItemRouteActive
    ...
    /// </summary>
    public class RouteConfigFix : IHttpModule
    {
        // Reflection handle to undo HttpApplication.CompleteRequest().
        // CompleteRequest sets this field to true; resetting it to false
        // lets the pipeline continue to AuthenticateRequest, PostAuth, etc.
        ...
        private void OnBeginRequest(object sender, EventArgs e)
        {
            ...
            // Only act when RouteConfig flagged a slug route
            if (app.Context.Items[Constants.ItemRouteActive] == null)
                return;
